...
import com.example.json.FieldConvertEnum;
...
public class JavaBeanDeserializer implements ObjectDeserializer {
        ...
        try {
            ...
            for (int fieldIndex = 0; ; fieldIndex++) {
                ...
                if (!matchField) {
                    ...
                    FieldConvertEnum fieldConvertEnum = FieldConvertEnum.getInstance(key);
                    if (fieldConvertEnum != null) {
                        key = fieldConvertEnum.getConvertName();
                    }
    ...
    protected com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer getSeeAlso(ParserConfig config, JavaBeanInfo beanInfo, String typeName) {
        if (beanInfo.jsonType == null) {
            return null;
        }
        ...
        for (Class<?> seeAlsoClass : beanInfo.jsonType.seeAlso()) {
            ...
            if (seeAlsoDeser instanceof com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer) {
                com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer seeAlsoJavaBeanDeser = (com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer) seeAlsoDeser;
                ...
                com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer subSeeAlso = getSeeAlso(config, subBeanInfo, typeName);
                if (subSeeAlso != null) {
                    return subSeeAlso;
                }
            }
